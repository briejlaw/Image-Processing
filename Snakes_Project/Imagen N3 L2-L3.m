...
load('./Coordenadas iniciales del snake externo/x_N3 L2-L3.mat');
load('./Coordenadas iniciales del snake externo/y_N3 L2-L3.mat');
figure, imshow (M_pts, [])
hold on;
plot(x,y);
initsnake_x=x;
...
load('./Coordenadas iniciales snake interno/xin_N3 L2-L3.mat');
load('./Coordenadas iniciales snake interno/yin_N3 L2-L3.mat');
figure, imshow (M_pts, [])
hold on;
plot(x,y);
initsnake_xin=x;
