...
%% Imagen N L5-S1 TSE.001.DCM

A = dicomread('./Imagenes/N L5-S1 TSE.001.DCM');
...
load('./Coordenadas iniciales del snake externo/x_N L5-S1 TSE_001.mat');
load('./Coordenadas iniciales del snake externo/y_N L5-S1 TSE_001.mat');
figure, imshow (M_pts, [])
hold on;
plot(x,y);
initsnake_x=x;
...
load('./Coordenadas iniciales snake interno/xin_N L5-S1 TSE.001.mat');
load('./Coordenadas iniciales snake interno/yin_N L5-S1 TSE.001.mat');
figure, imshow (M_pts, [])
hold on;
plot(x,y);
initsnake_xin=x;
...
B= imread('./GT/GT N L5-S1 TSE.001.tif');
